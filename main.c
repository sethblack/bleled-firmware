...
#define DEVICE_NAME                     "LED BLE Candle"                           /**< Name of device. Will be included in the advertising data. */
...
static app_timer_event_t m_app_timer_id;
...
static void timers_init(void)
{
    ...
    uint32_t err_code = app_timer_create(&m_app_timer_id, APP_TIMER_MODE_REPEATED, timer_timeout_handler);
    APP_ERROR_CHECK(err_code);
}
